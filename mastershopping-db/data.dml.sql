...
INSERT INTO BRANDS (brand_name) values ('ZARA'), ('TIMBERLAND'), ('COACH'),('GAP'),('GO SPORT');
INSERT INTO SIZES (size_name) values ('S'),('XS'),('M'),('L'),('XL'),('XXL');
INSERT INTO FABRICS (fabrics_name) values ('Coton'), ('Laine'),('Soie'), ('Paille');
INSERT INTO PRODUCTS (product_name,price,number_stock,categories_id,brands_id,sizes_id, fabrics_id) values ('Jean de Lorrenzo',50.00,5,2,1,1,1), ('Pantalon de noisette',78.79,7,1,3,4,2), ('Bonnet de bonheur',35,77,6,3,1,3), ('Echarpe Le Roselle',35.78,9,4,1,5,4), ('Le Roseau',8.89,10,3,4,3,3), ('La Boule de Neige', 89,91,1,5,1,1);
